...
f = open(os.path.join(script_dir, 'dataset/movies.dat'), 'r', encoding='ISO-8859-1')
items = f.readlines()
item_names = [_.split('::')[1].strip("\"") for _ in items]
...
movie_embedding_path = os.path.join(script_dir, 'dataset/embedding/movie_embedding.pt')
...
f = open('data/movie/result/movie_evaluation.json', 'w')    

...
def train(
    ...
    train_data_path: List[str] = ["data/movie/dataset/processed/train.json"],
    val_data_path: List[str] = ["data/movie/dataset/processed/valid_5000.json"],
    val_test_path: List[str] = ["data/movie/dataset/processed/test_5000.json"],
    output_dir: str = "./llama-7b-lora-alpaca-movie-0",
    sample: int = 1024,
    seed: int = 0,
    batch_size: int = 128,
